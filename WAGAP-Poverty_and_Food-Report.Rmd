...
wagap <- read_csv("data/WAGAP-survey-data.csv") %>% 
  clean_names()
...
wagap %>% 
  count(please_select_the_races_or_ethnicities_you_most_identify_with, is_food_a_challenge_in_your_community) %>% 
  mutate(grouped_ethnicities = case_when(please_select_the_races_or_ethnicities_you_most_identify_with %in% c("Pirate", "Blue") ~ "Not useful data",
                                         please_select_the_races_or_ethnicities_you_most_identify_with %in% c("Mixed", "mixed race") ~ "Mixed race",
