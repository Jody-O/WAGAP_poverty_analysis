...
# total all challenge level responses for labeling purposes
...
summary_food_plot <- food_challenges_by_ethnicity %>% 
  ...
  geom_col() + 
  geom_text(aes(label = sum_of_all_challenge_level_responses),
...
# QUESTION: how can I remove all but one sum_of_all_challenge_level_responses label from each bar in this plot?
