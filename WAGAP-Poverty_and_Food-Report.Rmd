...
food_challenges_by_ethnicity <- food_challenges_by_ethnicity %>% 
  ...
  mutate(total_in_food_challenge_level = sum(n)) %>% 
  ungroup()
...
summary_food_plot <- food_challenges_by_ethnicity %>% 
  ...
  geom_col() + 
  geom_text(aes(label = total_in_food_challenge_level),
