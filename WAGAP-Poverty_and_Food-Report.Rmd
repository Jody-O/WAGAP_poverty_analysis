...
# Findings - Community Member Survey Results
...
```{r}
ggplot(data = wagap,
       mapping = aes(x = is_food_a_challenge_in_your_community)) +
  geom_histogram(stat = "count")

```
```{r}
food_security_by_ethnicity <- wagap %>% 
  ...
  select(please_select_the_races_or_ethnicities_you_most_identify_with, please_mark_the_gender_you_most_identify_with, during_the_12_months_before_covid_19_lockdowns_in_march_did_you_or_the_people_you_live_with_worry_that_you_would_run_out_of_food_before_you_were_able_to_get_more, during_the_months_after_covid_19_lockdowns_did_you_or_the_people_you_live_with_worry_that_you_would_run_out_of_food_before_you_were_able_to_get_more, is_food_a_challenge_in_your_community)
 
food_security_by_ethnicity %>% 
   count(during_the_months_after_covid_19_lockdowns_did_you_or_the_people_you_live_with_worry_that_you_would_run_out_of_food_before_you_were_able_to_get_more, please_select_the_races_or_ethnicities_you_most_identify_with) %>% 
  arrange(n)
```

```{r} 
ggplot(data = food_security_by_ethnicity,
       mapping = aes(x = during_the_12_months_before_covid_19_lockdowns_in_march_did_you_or_the_people_you_live_with_worry_that_you_would_run_out_of_food_before_you_were_able_to_get_more)) +
  geom_bar()
